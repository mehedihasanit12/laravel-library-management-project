...
<div class="" style="background-image: url({{asset('/student/assets/image/library-bg-2.jpg')}}); background-repeat: no-repeat; background-size: cover;">
    <div class="font-[sans-serif] max-w-4xl flex items-center mx-auto md:h-screen p-4">
        <div class="bg-opacity-70 bg-white grid md:grid-cols-3 items-center shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-xl overflow-hidden">
            ...
            <form class="md:col-span-2 w-full py-6 px-6 sm:px-16 max-md:max-w-xl mx-auto">
                ...
                <p class="text-gray-600 text-sm mt-6 text-center">Already have an account? <a href="{{route('student.login')}}" class="text-blue-600 font-semibold hover:underline ml-1">Login here</a></p>
            </form>
        </div>
    </div>
</div>
