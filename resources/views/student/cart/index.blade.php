            ...
            <div class="md:col-span-2 space-y-4">
                ...
                <div class="flex gap-4 bg-white px-4 py-6 rounded-md shadow-[0_2px_12px_-3px_rgba(61,63,68,0.3)]">
                    <div class="flex gap-4">
                        ...
                        <div class="flex flex-col gap-4">
                            <div>
                                <h3 class="text-sm sm:text-base font-bold text-gray-800">Stylish Golden Watch</h3>
                ...
                <div class="flex gap-4 bg-white px-4 py-6 rounded-md shadow-[0_2px_12px_-3px_rgba(61,63,68,0.3)]">
                    <div class="flex gap-4">
                        ...
                        <div class="flex flex-col gap-4">
                            <div>
                                <h3 class="text-sm sm:text-base font-bold text-gray-800">Stylish Smart Watch</h3>
                    ...
                    <div class="ml-auto flex flex-col">
                        ...
                        <h3 class="text-sm sm:text-base font-bold text-gray-800 mt-auto">$70.00</h3>
                    </div>
                </div>
                ...
                <div class="flex gap-4 bg-white px-4 py-6 rounded-md shadow-[0_2px_12px_-3px_rgba(61,63,68,0.3)]">
                    <div class="flex gap-4">
                        ...
                        <div class="flex flex-col gap-4">
                            <div>
                                <h3 class="text-sm sm:text-base font-bold text-gray-800">Round Glass</h3>
                    ...
                    <div class="ml-auto flex flex-col">
                        ...
                        <h3 class="text-sm sm:text-base font-bold text-gray-800 mt-auto">$20.00</h3>
                    </div>
                </div>
            </div>
